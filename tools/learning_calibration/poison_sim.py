...
复刻 TemplateLearner 的策略数学(2026-09-04 定稿版;2026-09-05 二次修订:更新
目标按探针 yaw 姿态选槽,距离门对目标槽现算——本仿真单槽建模,d 本就是对
"被更新槽"的距离,数学不变),在合成嵌入上断言:
...
CLARITY = 0.10   # 落点明确性门(2026-09-05 起仅 V4 回退路径;与 P0-P2 无关,恒过)
